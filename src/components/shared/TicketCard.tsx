...
export const TicketCard = ({ 
  ...
  return (
    <div
      className={`w-full max-w-full bg-white/70 backdrop-blur-md rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/40 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:bg-white/80 transition-all duration-300 overflow-hidden border-l-4 cursor-pointer ${
